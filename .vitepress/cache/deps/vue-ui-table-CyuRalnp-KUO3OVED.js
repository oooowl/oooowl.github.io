...
// node_modules/vue-data-ui/dist/vue-ui-table-CyuRalnp.js
var X = {
  name: "vue-ui-table",
  props: {
    config: {
...
var Y = ["innerHTML"];
var K = ["data-is-open"];
var Z = F(() => createBaseVNode("b", { class: "vue-ui-table-export-hub-title" }, " Export ", -1));
...
var Je2 = F(() => createBaseVNode("th", { class: "invisible-cell" }, null, -1));
var Qe = ["innerHTML", "onClick", "onKeyup"];
var $e = ["data-row"];
var et = ["data-row"];
...
var Kt = ["y2", "stroke", "stroke-width"];
var Zt = ["x", "width", "height", "fill"];
  ...
  return openBlock(), createElementBlock("div", {
      ...
      createBaseVNode("div", {
        ...
        createBaseVNode("div", q, [
          createBaseVNode("div", J, [
            createBaseVNode("div", Q2, toDisplayString(e.FINAL_CONFIG.translations.exportAllLabel) + " (" + toDisplayString(t.bodyCopy.length) + ") ", 1),
            createBaseVNode("button", {
              id: "exportAll",
          ...
          createBaseVNode("div", ee, [
            createBaseVNode("div", te2, toDisplayString(e.FINAL_CONFIG.translations.exportPageLabel), 1),
            createBaseVNode("button", {
              id: "exportPage",
        ...
        createBaseVNode("thead", ne, [
          createBaseVNode("tr", null, [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(t.tableHead, (n, o) => (openBlock(), createElementBlock("th", {
              ...
              e.hasNumericTypes && ([t.constants.TEXT, t.constants.DATE].includes(n.type) || n.isPercentage) ? (openBlock(), createElementBlock("span", oe, [
        ...
        createBaseVNode("tbody", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(e.visibleRows, (n, o) => (openBlock(), createElementBlock("tr", {
            ...
            createBaseVNode("td", {
              ...
              "data-row": o % 2 === 0 ? "odd" : "even"
            }, toDisplayString(n.absoluteIndex + 1), 9, et),
            (openBlock(true), createElementBlock(Fragment, null, renderList(n.td, (d, y) => (openBlock(), createElementBlock("td", {
              ...
              }, null, 12, st2)) : createCommentVNode("", true),
              l.dataset.header[y].type === t.constants.DATE ? (openBlock(), createElementBlock("span", rt2, toDisplayString(l.dataset.header[y].prefix) + " " + toDisplayString(new Date(d).toLocaleString().slice(0, 10)) + " " + toDisplayString(l.dataset.header[y].suffix), 1)) : l.dataset.header[y].isPercentage ? (openBlock(), createElementBlock("span", nt, toDisplayString(Number((d * 100).toFixed(l.dataset.header[y].decimals)).toLocaleString()) + "% ", 1)) : t.percentages[y] && l.dataset.header[y].percentageTo && !l.dataset.header[y].isPercentage ? (openBlock(), createElementBlock("span", {
                key: 3,
      ...
      t.currentSelectionSpan.col !== void 0 && t.currentSelectionSpan.rows.length ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        ...
        createBaseVNode("span", null, [
          createBaseVNode("b", null, [
            ...
            l.dataset.header[t.currentSelectionSpan.col].isPercentage ? (openBlock(), createElementBlock("span", at, " / " + toDisplayString(l.dataset.header[t.percentages[t.currentSelectionSpan.col].referenceIndex].name), 1)) : createCommentVNode("", true)
          ]),
          ...
          createBaseVNode("span", ut, [
            ...
            l.dataset.header[t.currentSelectionSpan.col].isPercentage ? (openBlock(), createElementBlock("b", gt, "%")) : createCommentVNode("", true)
          ]),
    ...
    e.pages.length > 1 ? (openBlock(), createElementBlock("div", It, [
      ...
      e.pages.length > 3 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        ...
        e.pages.length > 10 ? (openBlock(), createElementBlock("div", kt2, [
        ...
        }, toDisplayString(e.pages.length), 13, Ot)
    ...
    t.showChart && e.canChart ? (openBlock(), createElementBlock("div", {
      ...
      createBaseVNode("div", Mt, [
        createBaseVNode("b", null, [
          ...
          t.chart.type === t.constants.DONUT && t.selectedDonutCategory && t.selectedDonutCategory.name ? (openBlock(), createElementBlock("span", Et, toDisplayString(e.FINAL_CONFIG.translations.by) + " " + toDisplayString(t.selectedDonutCategory.name), 1)) : createCommentVNode("", true)
        ])
      ]),
...
//# sourceMappingURL=vue-ui-table-CyuRalnp-KUO3OVED.js.map
