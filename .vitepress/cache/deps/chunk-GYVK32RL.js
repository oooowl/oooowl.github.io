// node_modules/.pnpm/vue-data-ui@2.4.1/node_modules/vue-data-ui/dist/html2canvas.esm-d2sM-0Wm.js
var mr = function(e, A) {
...
var Rn = function(e, A) {
  ...
  return e.forEach(function(n, s) {
    var i = Rr.get(n);
    if (i > ot ? (B.push(true), i -= ot) : B.push(false), ["normal", "auto", "loose"].indexOf(A) !== -1 && [8208, 8211, 12316, 12448].indexOf(n) !== -1)
...
var fB = (
  ...
  function() {
    ...
    return e.prototype.write = function(A) {
      ...
      for (var r = false; t === ve && A.length < 6; )
        A.push(t), t = this.consumeCodePoint(), r = true;
      if (r) {
    ...
    if (i === 0) {
      ...
      a = s.reduce(function(g, w) {
        if (o)
          ...
          return Array.isArray(r) || (r = []), r.push(w), false;
        return g;
      }, a);
    }
    if (a) {
  ...
  return sA(A).forEach(function(s, i) {
    ...
    if (i === 0 ? a = s.reduce(function(Q, g) {
      ...
      if (D(g))
        ...
        return Array.isArray(r) || (r = []), r.push(g), false;
      return Q;
    }, a)), a) {
      var o = er(e, s);
      B.push(o);
          ...
          switch (l.label) {
            ...
            case 14:
              if (r instanceof tt && (g = Math.min(r.bounds.width, r.bounds.height), r.type === Pe ? r.checked && (this.ctx.save(), this.path([
                ...
                new u(r.bounds.left + g * 0.39363, r.bounds.top + g * 0.79)
              ]), this.ctx.fillStyle = R(Jt), this.ctx.fill(), this.ctx.restore()) : r.type === ke && r.checked && (this.ctx.save(), this.ctx.beginPath(), this.ctx.arc(r.bounds.left + g / 2, r.bounds.top + g / 2, g / 4, 0, Math.PI * 2, true), this.ctx.fillStyle = R(Jt), this.ctx.fill(), this.ctx.restore())), EQ(r) && r.value.length) {
    ...
    return _(this, function(oA) {
      switch (oA.label) {
        case 0:
          ...
          }, n = Lr({ logging: (k = A.logging) !== null && k !== void 0 ? k : true, cache: A.cache }, B), s = {
...
vue-data-ui/dist/html2canvas.esm-d2sM-0Wm.js:
  (*!
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-GYVK32RL.js.map
