...
// node_modules/.pnpm/vue-data-ui@2.4.1/node_modules/vue-data-ui/dist/vue-ui-rating-b_iYZWF8.js
var et = {
  key: 0,
...
var mt = {
  ...
  setup(X, { expose: j, emit: B }) {
    const u = X, { vue_ui_rating: I } = oe(), m = ref(Lt()), z = ref(false), y = ref(void 0), b = ref([]), t = computed({
      get: () => C(),
      set: (l) => l
    });
    function C() {
            ...
            createBaseVNode("defs", null, [
              createBaseVNode("radialGradient", {
                ...
                createBaseVNode("stop", {
                  offset: "0%",
                  "stop-color": `${unref(pt)(t.value.style.star.activeColor, 0.05)}`
                }, null, 8, ot),
                createBaseVNode("stop", {
                  offset: "100%",
...
//# sourceMappingURL=vue-ui-rating-b_iYZWF8-KTLLHHZ6.js.map
