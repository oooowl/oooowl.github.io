...
// node_modules/.pnpm/vue-data-ui@2.4.1/node_modules/vue-data-ui/dist/vue-ui-cursor-y0kdr0uA.js
...
var ie = {
  ...
  setup(i) {
    const w = i, { vue_ui_cursor: S } = oe(), d = ref(Lt()), e = computed(() => c({
      userConfig: w.config,
      defaultConfig: S
    })), s2 = ref({
      x: -100,
    ...
    return onMounted(() => {
      ...
      e.value.showCenterCircle ? (openBlock(), createElementBlock("circle", {
        ...
        fill: unref(cr)(e.value.centerCircleColor, e.value.centerCircleOpacity * 100),
      ...
      e.value.showCoordinates ? (openBlock(), createElementBlock("g", se, [
        createBaseVNode("text", {
          ...
          "font-family": "Arial"
        }, toDisplayString(s2.value.x.toFixed(0)), 9, oe2),
        createBaseVNode("g", {
...
//# sourceMappingURL=vue-ui-cursor-y0kdr0uA-SFX6FF3J.js.map
