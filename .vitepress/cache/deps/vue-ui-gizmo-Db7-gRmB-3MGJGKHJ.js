...
// node_modules/vue-data-ui/dist/vue-ui-gizmo-Db7-gRmB.js
var P = ["viewBox", "width"];
var V = { key: 0 };
var D = ["id"];
var I = ["stop-color"];
...
var ee = {
  ...
  setup(f) {
    const o = f, { vue_ui_gizmo: k } = te(), l = ref(Dt());
    onMounted(() => {
      h();
    });
    function h() {
      !o.dataset && o.dataset !== 0 && qt({
...
//# sourceMappingURL=vue-ui-gizmo-Db7-gRmB-3MGJGKHJ.js.map
