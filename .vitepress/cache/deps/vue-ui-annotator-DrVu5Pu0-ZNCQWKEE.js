...
// node_modules/vue-data-ui/dist/vue-ui-annotator-DrVu5Pu0.js
var D = {
  props: {
    config: {
      type: Object,
      ...
      createBaseVNode("details", {
        ...
        createBaseVNode("div", W, [
          ...
          createBaseVNode("button", {
            ...
            (openBlock(), createElementBlock("svg", K, $)),
            e.FINAL_CONFIG.style.showTooltips ? (openBlock(), createElementBlock("span", {
              key: 0,
              class: "tooltiptext",
              style: normalizeStyle({
          ...
          createBaseVNode("button", {
            ...
            (openBlock(), createElementBlock("svg", et, st2)),
            e.FINAL_CONFIG.style.showTooltips ? (openBlock(), createElementBlock("span", {
              key: 0,
              class: "tooltiptext",
              style: normalizeStyle({
        ...
        createBaseVNode("div", ht, [
          createBaseVNode("button", {
            ...
            (openBlock(), createElementBlock("svg", at, [
          ...
          i.isTextMode ? (openBlock(), createElementBlock("div", te2, [
            createBaseVNode("button", {
              class: normalizeClass({
                "button-tool": true,
          ...
          createBaseVNode("div", se, [
            createBaseVNode("label", oe, toDisplayString(e.FINAL_CONFIG.translations.colorAlpha) + ": " + toDisplayString(i.transparency > 98 ? 100 : i.transparency) + " % ", 1),
            withDirectives(createBaseVNode("input", {
...
//# sourceMappingURL=vue-ui-annotator-DrVu5Pu0-ZNCQWKEE.js.map
